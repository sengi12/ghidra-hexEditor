...
public class saveT extends Thread {
   ...
   public void run() {
      ...
      if(this.v1 != null && this.v1.size() != 0) {
         ...
         try {
            ...
            for(var16 = new BufferedOutputStream(new FileOutputStream(var6), 2097152); var3 < this.v1.size() && this.next(); ++var3) {
               var9 = (edObj)this.v1.get(var3);
            ...
            if(this.editor.rAF != null) {
               this.editor.rAF.close();
            }
            ...
            this.editor.save2(this.f2);
         } catch (Exception var20) {
            JOptionPane.showMessageDialog(this.editor, var20);
            this.editor.save2((File)null);
         }
   ...
   private String toTime(long var1, long var3, long var5) {
      StringBuffer var7 = new StringBuffer(Float.toString((float)((int)((float)var1 / ((float)var3 / 1000.0F))) / 10.0F));
      var7.append("% saved");
      if(var1 != 0L) {
